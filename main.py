...
#keyword
keyword = ['gay炮','女權自助餐','陰陽人','剩女','男人婆','小白臉','花瓶','龍騎士','肥宅','爆乳','酥胸','美尻女神','火辣','大奶','巨乳','辣妹','台女','洋腸']
...
while real < data_num:
    ...
    #三立
    num_three = 971840 - i
    web_three = "https://star.setn.com/news/" + str(num_three) + "?utm_source=star.setn.com&utm_medium=hot&utm_campaign=hotnews"
